...
- **[nanogemm](https://github.com/eminsk/nanogemm)** — Minimalist, bare-metal AVX2+FMA SIMD matrix multiplication engine in ~100KB for Python, outperforming NumPy by up to 2.8x on CPU for edge neural network inference. Published on [PyPI](https://pypi.org/project/nanogemm/) and featured on [Dev.to](https://dev.to/eminsk/how-i-beat-numpy-matrix-multiplication-by-28x-with-a-100kb-c-microkernel-82k).
...
- **[yfinance-ta-patterns](https://github.com/eminsk/yfinance-ta-patterns)** — Algorithmic candlestick pattern scanner, backtesting and AI ranking suite powered by TA-Lib and yfinance. Published on [PyPI](https://pypi.org/project/yfinance-ta-patterns/) with automated GitHub Actions CI and Python 3.12–3.14 support.
